                ...
                <div class="row">
                    <div class="col l6 s12">
                        ...
                        <ul>
                            ...
                            <li class="grey-text text-lighten-3">
                                <i class="fa fa-envelope"></i> Email: <a href="mailto:quentin.rillet@gmail.com" target="_blank"> quentin.rillet@gmail.com</a>
                            </li>
                            <li class="grey-text text-lighten-3">
                                <i class="fa fa-twitter"></i> Twitter: <a href="https://twitter.com/RilletQuentin" target="_blank"> https://twitter.com/RilletQuentin</a>
                            </li>
                            <li class="grey-text text-lighten-3">
                                <i class="fa fa-linkedin"></i> Linked In:<a href="https://www.linkedin.com/in/quentinrillet/" target="_blank"> https://www.linkedin.com/in/quentinrillet</a>
                            </li>
                            <li class="grey-text text-lighten-3">
                                <i class="fa fa-viadeo"></i> Viadeo:<a href="http://www.viadeo.com/p/002ia26u8w0wbx8" target="_blank"> http://www.viadeo.com/p/002ia26u8w0wbx8</a>
                            </li>
                            <li class="grey-text text-lighten-3">
                                <i class="fa fa-github-alt"></i> GitHub: <a href="https://github.com/QuentinRillet" target="_blank"> https://github.com/QuentinRillet</a>
                    ...
                    <h5 class="white-text">Développé avec</h5>
                        <p>
                            <ul class="collection with-header">
                                ...
                                <li class="collection-item"><div>Symfony 3 <a href="http://symfony.com/" class="secondary-content" target="_blank"><i class="material-icons">send</i></a></div></li>
